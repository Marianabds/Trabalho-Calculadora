...
## Requisitos:
 - O aplicativo deve ter botões para números (0-9), para operadores (=,-,x,/,+,%) e para limpar (DEL,C).
...
<img width="413" height="784" alt="New board 1 (2)" src="https://github.com/user-attachments/assets/6d01733a-935e-44aa-a9e6-1d6ca725bb8c" />
